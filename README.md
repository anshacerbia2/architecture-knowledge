...
M2 hardening is complete. Hosted clean-checkout validation passed on Ubuntu and
Windows, and the separate Linux mutation job passed. M3 is eligible for a
separately scoped run; no M3 content was generated by this hardening run.
